...
export const sendWorkWithUsEmailService = async ({ city, email, name, message, phone, state, curriculum, contentType, curriculumBase64 }:  Omit<IWorkWithUsFormTypeWithBase64, 'store'>
